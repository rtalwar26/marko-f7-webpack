...
export const build_query = async (operation, variables, fields) => {

    return build_query_string('query', operation, variables, fields);
}

export const build_mutation_query = async (operation, variables, fields) => {
    return build_query_string('mutation', operation, variables, fields);
}

export const fetch_return_schema = (input: { query: string, url: string, operation: string }) => {
...
export const fetch_args_schema = (input: { query: string, url: string, operation: string }) => {
